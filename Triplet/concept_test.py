...
model_path ='/root/autodl-tmp/VERSION_TWO/Close_world/Triplet/model_save/closeworld_3epoch.pt'
...
for TASK in range(len(all_data_list) - delay):
    ...
    for n_shot in n_shot_list:
        ...
        signature_vector_dict, test_vector_dict = create_test_set_AWF_concept_test(feature_model,n_shot,few_shot_train_data,few_shot_train_label,test_data,test_label,num_base_class)
