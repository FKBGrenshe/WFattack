...
from dataset import *
''''''
# AWF775_data, AWF775_label, AWF100_data, AWF100_label,uni_labels  = load_AWF100_and_775()

# AWF100_data, AWF100_label = load_AWF100()
''''''
...
AWF775_data, AWF775_label = load_AWF_closeworld_200w()
''''''
X_train,X_test, y_train, y_test =train_test_split(AWF775_data,AWF775_label,test_size=num_sample*num_base_class, random_state=42,shuffle=True,stratify=AWF775_label)
# X_train,X_test, y_train, y_test = AWF775_data, AWF100_data, AWF775_label,  AWF100_label
''''''
y_labels = y_test
...
for epoch in tqdm(range(nb_epochs),desc='Epoch'):
    # if epoch == 15:
    #     t.save(feature_model.state_dict(), '/root/autodl-tmp/VERSION_ONE/Triplet/AWF_version/luo_version/save_luo_model/luo_awf_15epoch.pt')
...
t.save(feature_model.state_dict(), '/root/autodl-tmp/VERSION_TWO/Close_world/Triplet/model_save/closeworld_200w_triplet.pt')
